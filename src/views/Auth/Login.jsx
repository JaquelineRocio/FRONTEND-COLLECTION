  ...
  if(isLogin){
    ...
    <>
      ...
      <div className="flex h-screen">
          {/* <!-- Right Pane --> */}
          <div className="w-full bg-gray-200 lg:w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6 " >
            ...
            <h1 className="text-4xl font-semibold mb-3 text-black text-center">Bienvenido</h1>
            <h1 className="text-3xl mb-6 text-gray-700 text-center">Sistema de cobranza </h1>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input value={inputUser} onChange={handleUserInputChange} placeholder="Ingrese su nombre de usuario" type="text" id="username" name="username" className="mt-1 p-3 w-full border border-gray-800/30 rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-blue-900 transition-colors duration-300"/>
              </div>
              {/* <div>
              ...
              <div>
                ...
                <input value={inputPassword} onChange={handlePasswordInputChange} placeholder="Ingrese contraseña" type="password" id="password" name="password" className="mt-1 p-3 w-full border border-gray-800/30 rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-blue-900 transition-colors duration-300"/>
                {/* <Input color="indigo" className="bg-white" label="Ingrese contraseña" /> */}
              
              
              </div>
              <div className="mt-4 text-sm text-gray-600 text-right">
                <p><a href="#" className="text-black hover:underline">¿Olvidaste tu usuario ó contraseña?</a>
                </p>
              </div>
              <div>
                ...
                <button onClick={handleSubmit} type="button" className="w-full bg-blue-900 text-white p-3 rounded-md hover:bg-blue-950 focus:outline-none focus:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-900 transition-colors duration-300">Ingresar</button>
...
{/* 
          <Carousel className="rounded-lg max-w-screen-xl ">
            <img
              src={uno}
              alt="image 1"
