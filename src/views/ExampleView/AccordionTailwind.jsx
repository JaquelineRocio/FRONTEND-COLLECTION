...
// export default function AccordionTailwind() {
...
//         <AccordionHeader
//           onClick={() => handleOpen(3)} className={`border-b-0 transition-colors ${open === 3 ? "text-blue-500 hover:!text-blue-700" : "" }`}
//         >
...
export default function AccordionTailwind() {
  ...
  return (
    <>
      ...
      <div open={open === 1} className="mb-2 rounded-lg border border-blue-gray-100 px-4">
        <div
          onClick={() => handleOpen(1)}
          className={`border-b-0 transition-colors ${
            open === 1 ? "text-blue-500 hover:!text-blue-700" : ""
